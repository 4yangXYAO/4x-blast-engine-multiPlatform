...
- Requires random delays between actions (20â€“40s for comments, 35â€“60s for DMs)
- Randomizes action types (70% comment / 30% chat)
- Has a hard cap at 30 actions per run
- Must complete as a single unit of work

Using the queue would fragment this coordination â€” delays would need to be encoded as job metadata, action randomization would need to happen at enqueue time, and the 30-action cap would require tracking state across multiple queue consumers.
...
|--------|------------|-----------|
| Comment | 20â€“40 seconds | Mimics human browsing + commenting cadence |
| Chat/DM | 35â€“60 seconds | DMs are more monitored; longer delays reduce detection risk |
